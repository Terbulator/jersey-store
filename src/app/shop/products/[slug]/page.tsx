...
export default function ProductPage({ params }: ProductPageProps) {
  ...
  if (!product) {
    return (
      <section className="min-h-screen pt-40 sm:pt-48 px-4 text-center bg-black">
        <p className="eyebrow">404</p>
        <h1 className="headline text-4xl text-off-white mt-4">Product not found</h1>
        <Link href="/shop" className="btn-pill btn-pill-solid mt-10">
          Back to Shop
        </Link>
      </section>
    );
  ...
  const rel = relatedProducts(product, 4);
