...
export default function OwnerResellers() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Review and configure reseller commissions and tiers.</p>
      </div>
